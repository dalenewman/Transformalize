REM Main
nuget push "c:\temp\modules\Transformalize.0.11.7-beta.nupkg" -source https://www.myget.org/F/transformalize/api/v3/index.json

REM Dependency Injection 
nuget push "c:\temp\modules\Transformalize.Container.Autofac.0.11.7-beta.nupkg" -source https://www.myget.org/F/transformalize/api/v3/index.json
...
REM nuget push "c:\temp\modules\Transformalize.Provider.Console.Autofac.0.11.4-beta.nupkg" -source https://www.myget.org/F/transformalize/api/v3/index.json
