...
REM TRANSFORMS
nuget pack Transformalize.Transform.JavaScript.nuspec -OutputDirectory "c:\temp\modules"
...
nuget pack Transformalize.Transform.DateMath.nuspec -OutputDirectory "c:\temp\modules"
