...
namespace Transformalize.Test.Unit {
    ...
    public class TestAggregations {
        ...
        private readonly IOperation _testInput = new RowsBuilder()
            .Row("order", 1).Field("year", "2000").Field("int32", 2000).Field("int64", null).Field("guid", Guid.Parse("e2cf0d95-1d29-4bed-9b31-ce5b5628466b")).Field("byte[]", new byte[] { 0, 0, 0 })
            .Row("order", 1).Field("year", "2000").Field("int32", 2000).Field("int64", (Int64)2000).Field("guid", Guid.Parse("c4eb4889-b3ff-47ed-8b7a-7f0374fac7f6")).Field("byte[]", new byte[] { 0, 0, 0 })
            .Row("order", 1).Field("year", "2000").Field("int32", 2000).Field("int64", (Int64)2000).Field("guid", null).Field("byte[]", new byte[] { 0, 0, 0 })
            .Row("order", 1).Field("year", "2001").Field("int32", 2001).Field("int64", (Int64)2001).Field("guid", null).Field("byte[]", new byte[] { 0, 0, 1 })
            .Row("order", 1).Field("year", "2002").Field("int32", 2002).Field("int64", (Int64)2002).Field("guid", null).Field("byte[]", new byte[] { 0, 0, 2 })
            .Row("order", 2).Field("year", "2000").Field("int32", 2000).Field("int64", (Int64)2000).Field("guid", Guid.Parse("e2cf0d95-1d29-4bed-9b31-ce5b5628466b")).Field("byte[]", new byte[] { 0, 0, 0 })
            .Row("order", 2).Field("year", "2000").Field("int32", 2000).Field("int64", (Int64)2000).Field("guid", Guid.Parse("cd5cb6c8-4cbe-40c5-b17d-c17aee4196a2")).Field("byte[]", new byte[] { 0, 0, 0 })
            .ToOperation();
        ...
        public void TestMax() {
            ...
            var cfg = new ProcessBuilder("process")
                ...
                .Entity("entity")
                    ...
                    .Field("byte[]").Aggregate("max").Type("byte[]")
                .Process();
            ...
            Assert.AreEqual(new Byte[] { 0, 0, 2 }, r1["byte[]"]);
            ...
            Assert.AreEqual(new Byte[] { 0, 0, 0 }, r2["byte[]"]);
        }
        ...
        public void TestMin() {
            ...
            var cfg = new ProcessBuilder("process")
                ...
                .Entity("entity")
                    ...
                    .Field("byte[]").Aggregate("min").Type("byte[]")
                .Process();
            ...
            Assert.AreEqual(new Byte[] { 0, 0, 0 }, r1["byte[]"]);
