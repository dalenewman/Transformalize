...
using Transformalize.Transforms.Web;
...
namespace Pipeline.Web.Orchard.Modules {
   ...
   public class TransformModule : Module {
      ...
      protected override void Load(ContainerBuilder builder) {
         ...
         // xml
         RegisterTransform(builder, (ctx, c) => c.Operation.Mode == "all" ? new Transformalize.Transforms.Xml.FromXmlTransform(c) : new Transformalize.Transforms.FromXmlTransform(c) as ITransform, new[] { new OperationSignature("fromxml") });
