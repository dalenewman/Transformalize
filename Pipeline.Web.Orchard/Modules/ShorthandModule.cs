...
namespace Pipeline.Web.Orchard.Modules {
    ...
    public class ShorthandModule : Module {
        ...
        protected override void Load(ContainerBuilder builder) {
            ...
            builder.Register<Cfg.Net.Contracts.IDependency>((ctx, p) => {
                ShorthandRoot root;
                if (ctx.IsRegisteredWithName<string>("shorthand")) {
                    root = new ShorthandRoot(ctx.ResolveNamed<string>("shorthand"), ctx.ResolveNamed<Cfg.Net.Contracts.IReader>("file"));
                } else {
            ...
            }).Named<Cfg.Net.Contracts.IDependency>("shorthand").SingleInstance();
        }
