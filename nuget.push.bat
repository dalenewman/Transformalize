...
nuget push "c:\temp\modules\Transformalize.0.3.7-beta.nupkg" -source https://api.nuget.org/v3/index.json
...
nuget push "c:\temp\modules\Transformalize.Provider.Ado.0.3.10-beta.nupkg" -source https://api.nuget.org/v3/index.json
