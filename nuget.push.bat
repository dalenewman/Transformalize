...
rem nuget push "c:\temp\modules\Transformalize.0.3.5-beta.nupkg" -source https://api.nuget.org/v3/index.json
...
rem nuget push "c:\temp\modules\Transformalize.Provider.Ado.0.3.8-beta.nupkg" -source https://api.nuget.org/v3/index.json
