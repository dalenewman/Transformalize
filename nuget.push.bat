...
REM nuget push "c:\temp\modules\Transformalize.0.3.12-beta.nupkg" -source https://api.nuget.org/v3/index.json
...
nuget push "c:\temp\modules\Transformalize.Provider.OpenXml.0.3.12-beta.nupkg" -source https://api.nuget.org/v3/index.json
