...
namespace Transformalize {
   public static class Constants {
     ...
     private static readonly Regex _timeOffset = new Regex(@"[+|-][0-1][0-9]:[0-5][0-9]|Z$");
      ...
      public const string ProviderDomain = "sqlserver,internal,file,folder,elasticsearch,solr,mysql,postgresql,console,trace,sqlce,sqlite,lucene,excel,web,log,filesystem,geojson,json,kml,text,ssas,rethinkdb,word,razor,velocity,clevest,access,bogus,mail,activedirectory,accord.net,firehose," + DefaultSetting;
