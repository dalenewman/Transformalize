...
namespace Transformalize.Data {
    public class SqlServerEntityCounter : IEntityCounter {
        ...
        public SqlServerEntityCounter(IConnectionChecker connectionChecker) {
            _connectionChecker = connectionChecker;
            _entityExists = new SqlServerEntityExists();
        }

        public int CountInput(Entity entity) {
            if (_connectionChecker.Check(entity.InputConnection.ConnectionString)) {
        ...
        public int CountOutput(Entity entity) {
            if (_connectionChecker.Check(entity.OutputConnection.ConnectionString)) {
