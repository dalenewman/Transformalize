...
namespace Transformalize.Configuration {
    ...
    public class Operation : CfgNode {
        ...
        public const string ValidatorDomain = "contains,is,equals,in,startswith,endswith,isempty,empty,isdefault,default,isnumeric,numeric,vinisvalid,isdaylightsavings,ismatch,matches,required,map,all";
