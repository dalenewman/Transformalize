...
namespace Transformalize.Configuration.Ext {
    public static class ProcessValidate {
        ...
        private static void ValidateTransform(IContext context, Transform lastTransform, Action<string> error) {
        ...
        private static void ValidateTransforms(Process p, Action<string> error) {
