...
namespace Transformalize.Configuration {
    ...
    public class Operation : CfgNode {
        ...
        public const string ValidatorDomain = "contains,is,equal,equals,in,startswith,endswith,isempty,empty,isdefault,default,notequal,unequal,numeric,vinisvalid,isdaylightsavings,ismatch,matches,required,map,all,length,min,max,alphanum";
