...
namespace Transformalize.Libs.Nest.Domain.Mapping.Descriptors
{
	public class SingleMappingDescriptor<T> where T : class
	{
		...
		public IElasticType String(Func<StringMappingDescriptor<T>, StringMappingDescriptor<T>> selector)
		{
			...
			if (d == null)
				throw new System.Exception("Could not get string mapping");
			return d._Mapping;
		}
		...
		public IElasticType Number(Func<NumberMappingDescriptor<T>, NumberMappingDescriptor<T>> selector)
		{
			...
			if (d == null)
				throw new System.Exception("Could not get number mapping");
			return d._Mapping;
		}
		...
		public IElasticType Date(Func<DateMappingDescriptor<T>, DateMappingDescriptor<T>> selector)
		{
			...
			if (d == null)
				throw new System.Exception("Could not get date mapping");
			return d._Mapping;
		}
		...
		public IElasticType Boolean(Func<BooleanMappingDescriptor<T>, BooleanMappingDescriptor<T>> selector)
		{
			...
			if (d == null)
				throw new System.Exception("Could not get boolean mapping");
			return d._Mapping;
		}
		...
		public IElasticType Binary(Func<BinaryMappingDescriptor<T>, BinaryMappingDescriptor<T>> selector)
		{
			...
			if (d == null)
				throw new System.Exception("Could not get binary mapping");
			return d._Mapping;
		}
		public IElasticType Attachment(Func<AttachmentMappingDescriptor<T>, AttachmentMappingDescriptor<T>> selector)
		{
			...
			if (d == null)
				throw new System.Exception("Could not get attachment mapping");
			return d._Mapping;
		}
			...
			where TChild : class
		{
			...
			if (d == null)
				throw new System.Exception("Could not get object mapping");
			return d._Mapping;
		}
			...
			where TChild : class
		{
			...
			if (d == null)
				throw new System.Exception("Could not get nested object mapping");
			return d._Mapping;
		}
		...
		public IElasticType MultiField(Func<MultiFieldMappingDescriptor<T>, MultiFieldMappingDescriptor<T>> selector)
		{
			...
			if (d == null)
				throw new System.Exception("Could not get multifield mapping");
			return d._Mapping;
		}
		public IElasticType IP(Func<IPMappingDescriptor<T>, IPMappingDescriptor<T>> selector)
		{
			...
			if (d == null)
				throw new System.Exception("Could not get IP mapping");
			return d._Mapping;
		}
		...
		public IElasticType GeoPoint(Func<GeoPointMappingDescriptor<T>, GeoPointMappingDescriptor<T>> selector)
		{
			...
			if (d == null)
				throw new System.Exception("Could not get geo point mapping");
			return d._Mapping;
		}
		...
		public IElasticType GeoShape(Func<GeoShapeMappingDescriptor<T>, GeoShapeMappingDescriptor<T>> selector)
		{
			...
			if (d == null)
				throw new System.Exception("Could not get geo shape mapping");
			return d._Mapping;
		}
		...
		public IElasticType Generic(Func<GenericMappingDescriptor<T>, GenericMappingDescriptor<T>> selector)
		{
			...
			if (d == null)
				throw new System.Exception("Could not get generic mapping");
			return d._Mapping;
		}
        ...
        public IElasticType Completion(Func<CompletionMappingDescriptor<T>, CompletionMappingDescriptor<T>> selector)
        {
            ...
            if (d == null)
                throw new System.Exception("Could not get completion mapping");
            return d._Mapping;
        }
