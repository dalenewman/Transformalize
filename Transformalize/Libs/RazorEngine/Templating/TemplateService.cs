...
namespace Transformalize.Libs.RazorEngine.Templating
{
    ...
    public class TemplateService : MarshalByRefObject, ITemplateService
    {
        ...
        {
            get { return _config.EncodedStringFactory; }
        }
        ...
        {
            return GetTemplate<object>(razorTemplate, model, cacheName);
        }
        ...
        /// <returns>
        ///     An instance of <see cref="InstanceContext" />.
        /// </returns>
        [Pure]
        ...
        /// <returns>
        ///     An instance of <see cref="IEncodedStringFactory" />
        /// </returns>
        ...
        /// <returns>
        ///     An instance of <see cref="IParallelQueryPlan{T}" />.
        /// </returns>
