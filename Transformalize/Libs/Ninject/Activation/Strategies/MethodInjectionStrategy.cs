...
namespace Transformalize.Libs.Ninject.Activation.Strategies
{
    ...
    public class MethodInjectionStrategy : ActivationStrategy
    {
        ...
        public override void Activate(IContext context, InstanceReference reference)
        {
            ...
            foreach (MethodInjectionDirective directive in context.Plan.GetAll<MethodInjectionDirective>())
            {
                IEnumerable<object> arguments = directive.Targets.Select(target => target.ResolveWithin(context));
