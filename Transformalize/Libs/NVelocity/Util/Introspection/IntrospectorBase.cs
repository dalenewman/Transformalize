...
namespace Transformalize.Libs.NVelocity.Util.Introspection
{
    /// <summary>
	...
	public abstract class IntrospectorBase
	{
		...
		public virtual MethodInfo GetMethod(Type c, String name, Object[] parameters)
		{
			if (c == null)
			{
				throw new System.Exception(string.Format("Introspector.getMethod(): Class method key was null: {0}", name));
			}
