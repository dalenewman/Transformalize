...
using System;
using Transformalize.Libs.NVelocity.Runtime.Resource;

namespace Transformalize.Libs.NVelocity.Runtime
{
    /// <summary>
	...
	public struct RuntimeConstants
	{
		...
		public const String DEFAULT_RUNTIME_PROPERTIES = "Transformalize.Libs.NVelocity.Runtime.Defaults.nvelocity.properties";
        public const String DEFAULT_RUNTIME_DIRECTIVES = "Transformalize.Libs.NVelocity.Runtime.Defaults.directive.properties";
