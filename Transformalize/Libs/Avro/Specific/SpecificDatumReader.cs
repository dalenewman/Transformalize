...
namespace Transformalize.Libs.Avro.Specific
{
    ...
    public class SpecificDatumReader<T> : PreresolvingDatumReader<T>
    {
        ...
        private static ObjectCreator.CtorDelegate GetConstructor(string name, Schema.Schema.Type schemaType)
        {
        ...
        private class SpecificRecordAccess : RecordAccess
        {
            ...
            {
                objCreator = GetConstructor(readerSchema.Fullname, Schema.Schema.Type.Record);
            }
        ...
        private class SpecificFixedAccess : FixedAccess
        {
            ...
            {
                objCreator = GetConstructor(readerSchema.Fullname, Schema.Schema.Type.Fixed);
            }
        ...
        private class SpecificArrayAccess : ArrayAccess
        {
            ...
            public SpecificArrayAccess(ArraySchema readerSchema)
            {
                ...
                objCreator = GetConstructor(type, Schema.Schema.Type.Array);
            }
        ...
        private class SpecificMapAccess : MapAccess
        {
            ...
            public SpecificMapAccess(MapSchema readerSchema)
            {
                ...
                objCreator = GetConstructor(type, Schema.Schema.Type.Map);
            }
