...
namespace Transformalize.Libs.Lucene.Net.Index
{
    ...
    public class MultiReader:IndexReader, System.ICloneable
    {
        ...
        {
            EnsureOpen();
            return new DirectoryReader.MultiTermEnum(this, subReaders, starts, null);
        }
        
        public override TermEnum Terms(Term term)
        {
            EnsureOpen();
            return new DirectoryReader.MultiTermEnum(this, subReaders, starts, term);
        }
        ...
        {
            EnsureOpen();
            return new DirectoryReader.MultiTermDocs(this, subReaders, starts);
        }
        
        public override TermPositions TermPositions()
        {
            EnsureOpen();
            return new DirectoryReader.MultiTermPositions(this, subReaders, starts);
        }
