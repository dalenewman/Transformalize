...
namespace Transformalize.Libs.Lucene.Net.Index
{
	...
	public sealed class DocumentsWriter : IDisposable
	{
		...
		* including any flushed segments. */
		...
		/// flush. 
		/// </summary>
		internal bool AddDocument(Document.Document doc, Analyzer analyzer)
		{
			return UpdateDocument(doc, analyzer, null);
		}
		
		internal bool UpdateDocument(Term t, Document.Document doc, Analyzer analyzer)
		{
			return UpdateDocument(doc, analyzer, t);
		}
		
		internal bool UpdateDocument(Document.Document doc, Analyzer analyzer, Term delTerm)
		{
