...
using Transformalize.Libs.Lucene.Net.Support;
using Transformalize.Libs.Lucene.Net.Util;
using Directory = Transformalize.Libs.Lucene.Net.Store.Directory;

namespace Transformalize.Libs.Lucene.Net.Index
{
    ...
    */
    public class IndexWriter : System.IDisposable
	{
		...
		/// <throws>  CorruptIndexException if the index is corrupt </throws>
		/// <throws>  IOException if there is a low-level IO error </throws>
		public virtual void  AddDocument(Document.Document doc)
		{
		...
		/// discarded.
		/// 
		/// <p/>See <see cref="AddDocument(Document.Document)" /> for details on
		...
		/// <throws>  CorruptIndexException if the index is corrupt </throws>
		/// <throws>  IOException if there is a low-level IO error </throws>
		public virtual void  AddDocument(Document.Document doc, Analyzer analyzer)
		{
			EnsureOpen();
			bool doFlush = false;
			bool success = false;
		...
		/// <throws>  CorruptIndexException if the index is corrupt </throws>
		/// <throws>  IOException if there is a low-level IO error </throws>
		public virtual void  UpdateDocument(Term term, Document.Document doc)
		{
			EnsureOpen();
		...
		/// <throws>  CorruptIndexException if the index is corrupt </throws>
		/// <throws>  IOException if there is a low-level IO error </throws>
		public virtual void  UpdateDocument(Term term, Document.Document doc, Analyzer analyzer)
		{
			EnsureOpen();
			try
			{
