...
namespace Transformalize.Libs.Lucene.Net.Document
{
	...
	/// what Fields get loaded on a <see cref="Document" /> by <see cref="Lucene.Net.Index.IndexReader.Document(int,FieldSelector)" />
	/// </summary>
