...
using Transformalize.Libs.Lucene.Net.Search.Spans;
using Transformalize.Libs.Lucene.Net.Util;

namespace Transformalize.Libs.Lucene.Net.Search.Payloads
{
	...
	public class PayloadNearQuery:SpanNearQuery, System.ICloneable
	{
		...
		public class PayloadNearSpanScorer:SpanScorer
		{
			...
			/// 
			/// </param>
			/// <seealso cref="Transformalize.Libs.Lucene.Net.Search.Spans">
			/// </seealso>
