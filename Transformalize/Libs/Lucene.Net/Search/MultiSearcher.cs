...
namespace Transformalize.Libs.Lucene.Net.Search
{
	...
	public class MultiSearcher:Searcher
	{
		...
		private class CachedDfSource:Searcher
		{
			...
			public override Document.Document Doc(int i)
			{
				throw new System.NotSupportedException();
			}
		...
		// inherit javadoc
		public override Document.Document Doc(int n)
		{
		...
		// inherit javadoc
		public override Document.Document Doc(int n, FieldSelector fieldSelector)
		{
			int i = SubSearcher(n); // find searcher index
