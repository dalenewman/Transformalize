...
using Transformalize.Libs.FileHelpers.Interfaces;
using Transformalize.Libs.FileHelpers.MasterDetail;
...
namespace Transformalize.Libs.FileHelpers.Engines
{
    ...
    /// <summary>
    ///     <para>
    ///         This engine allows you to parse and write files that contain
...
#endif
    {
        ...
        {
            using (var fs = new StreamReader(fileName, mEncoding, true))
            {
                object[] tempRes;
        ...
        public object[] ReadStream(TextReader reader)
        {
            ...
            var freader = new ForwardReader(reader, mMultiRecordInfo[0].mIgnoreLast);
        ...
        {
            using (var fs = new StreamWriter(fileName, false, mEncoding))
            {
        ...
        public void WriteStream(TextWriter writer, IEnumerable records, int maxRecords)
        {
            ...
            foreach (var rec in records)
            {
                ...
                try
                {
                    ...
                    var info = (RecordInfo) mRecordInfoHash[rec.GetType()];
        ...
        /// <summary>
        ///     Write the next record to a file or stream opened with <see cref="BeginWriteFile" />, <see cref="BeginWriteStream" /> or
        ///     <see
        ///         cref="BeginAppendToFile" />
        ///     method.
        /// </summary>
        ...
        /// <summary>
        ///     Write the nexts records to a file or stream opened with <see cref="BeginWriteFile" />, <see cref="BeginWriteStream" /> or
        ///     <see
        ///         cref="BeginAppendToFile" />
        ///     method.
        /// </summary>
...
//#endif
                ...
                var info = (RecordInfo) mRecordInfoHash[record.GetType()];
        ...
        /// <remarks>
        ///     <para>
        ///         When you finish to write to the file you must call
        ///         <b>
        ///             <see cref="Close" />
        ///         </b>
        ///         method.
        ...
        /// <summary>
        ///     Open a file for write operations. If exist the engine override it. You can use <see cref="WriteNext" /> or
        ///     <see
        ///         cref="WriteNexts" />
        ///     to write records.
        /// </summary>
