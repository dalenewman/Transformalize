...
//					}
        ...
        protected override void CreateFieldString(StringBuilder sb, object fieldValue)
        {
            ...
            if (hasNewLine &&
                ...
                throw new BadUsageException("One value for the field " + mFieldInfo.Name + " has a new line inside. To allow write this value you must add a FieldQuoted attribute with the multiline option in true.");
