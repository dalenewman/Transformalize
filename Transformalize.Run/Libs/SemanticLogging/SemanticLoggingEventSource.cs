...
namespace Transformalize.Run.Libs.SemanticLogging
{
    /// <summary>
    /// An <see cref="EventSource"/> class to notify non-transient faults and internal trace information.
    /// </summary>
    [EventSource(Name = "Microsoft-SemanticLogging", LocalizationResources = "Transformalize.Libs.SemanticLogging.SemanticLoggingEventSourceResources")]
