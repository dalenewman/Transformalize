...
using Transformalize.Run.Libs.SemanticLogging.Configuration;
using Transformalize.Run.Libs.SemanticLogging.Properties;

namespace Transformalize.Run.Libs.SemanticLogging.Utility
{
    internal static class XmlUtil
    {
        ...
        internal static T CreateInstance<T>(XElement element)
        {
            ...
            {
                throw new ArgumentException(Resources.IncompleteArgumentsError, e);
            }
        }
