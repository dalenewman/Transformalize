...
namespace Pipeline.DotNetFiddle.Impl {
    public static class TransformFactory {
        ...
        public static ITransform ShouldRunTransform(PipelineContext context, ITransform js, ITransform razor) {
        ...
        static ITransform SwitchTransform(PipelineContext context, ITransform js, ITransform razor) {
