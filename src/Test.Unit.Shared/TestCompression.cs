   ...
   public class TestCompression {
      ...
      public void TestCompressIsDefined() {
         ...
         using (var c = container.CreateScope(cfg, new ConsoleLogger())) {
            ...
            Assert.AreEqual("egAAAB+LCAAAAAAABABLzi/NSVEozs9Nzc9LVSjISU0sTlVIzs8tKEotLlbITbUHcgipUMhUyEtNTVEoyVdIQkilpugpwLUVZ4BNQdKmBwCqA+CnegAAAA==", process.Parameters.First().Value);
         }
      }
