...
namespace Transformalize.Transforms {
    public class PadRightTransform : BaseTransform {
        ...
        public PadRightTransform(IContext context = null): base(context, "string") {
        ...
        public override IRow Operate(IRow row) {
            row[Context.Field] = row[_input].ToString().PadRight(Context.Operation.TotalWidth, Context.Operation.PaddingChar);
            return row;
        }

        public override IEnumerable<OperationSignature> GetSignatures() {
            yield return new OperationSignature("padright") {
