...
namespace Transformalize.Providers.Oracle {
    ...
    public class OracleConnectionFactory : IConnectionFactory {
        ...
        public IDbConnection GetConnection(string appName = null) {
            return new OracleConnection(GetConnectionString(appName));
        }
        ...
        public string GetConnectionString(string appName = null) {
            ...
            _c.ConnectionString = new OracleConnectionStringBuilder {
                ConnectionTimeout = _c.RequestTimeout,
        ...
        public string SqlDataType(Field f) {
            ...
            var dimensions = (new[] { "decimal" }).Any(s => s.Equals(f.Type)) ? $"({f.Precision},{f.Scale})" : string.Empty;
